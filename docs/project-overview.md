...
```
aon-demo-test         <- Root directory. Both monorepo and polyrepo are supported.
│
├── aon_demo_test       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
